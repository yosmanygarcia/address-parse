export const data = [
  ...
  // // }
  //
  // // Table AttomForeclosure, id 6127
  // // auctionAddress: 'Hennepin County Sheriff's Office, Civil Division, Room 30, 350 South 5th Street'
  // // auctionHouseNumber: '350'
  // // auctionDirection: 'S'
  // // auctionStreetName: '5TH'
  // // auctionPostDirection: 'S'
  // // auctionUnit: '30'
  // // auctionCity: 'Minneapolis'
  // {
  //   address: 'Hennepin County Sheriff\'s Office, Civil Division, Room 30, 350 South 5th Street',
  //   parsed: {
  //     house_number: '350',
  //     road: 'south 5th street',
  //     city: null,
  //     state: null,
  //     postcode: null,
  //     unit: 'room 30'
  ...
  //
  // {
  //   address: 'First Floor Lobby Of El Paso County Court House 500 E San Antonio',
  //   parsed: {
  //     house_number: '500',
  //     road: 'e',
  //     city: 'san antonio',
